    ...
    var settings = {
        ...
        apiRoutes: {
            ...
            '/members/services/ManageYourPolicy/getPolicyDetails': './api/member.apib',
            '/members/services/DocumentService/getBBDocumentByProduct': './api/benefitBooklet.apib'
        ...
        serveRoutes: {
            ...
            '/assets/members/secure/apps/manage-policy/images/': './src/images'
        },
        ...
        dist:           './dist/assets/members/secure/apps/manage-policy',
        distStyles:     './dist/assets/members/secure/apps/manage-policy/css',
        distJSON:       './dist/templatedAssets/members/secure/data',
        distApp:        './dist/templatedAssets/members/secure/account/manage-policy/',
